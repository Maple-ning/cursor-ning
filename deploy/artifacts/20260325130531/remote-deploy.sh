...
tar -xzf '/tmp/cursor-deploy-20260325130531/backend.tar.gz' -C '/home/blog-server/app'
...
tar -xzf '/tmp/cursor-deploy-20260325130531/blog-admin-dist.tar.gz' -C '/usr/share/nginx/html/admin' --strip-components=1
...
tar -xzf '/tmp/cursor-deploy-20260325130531/blog-front-dist.tar.gz' -C '/usr/share/nginx/html/blog' --strip-components=1
echo 'Frontend deployed (flat): blog-front -> /usr/share/nginx/html/blog'

rm -rf '/tmp/cursor-deploy-20260325130531'
