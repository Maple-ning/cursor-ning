...
tar -xzf '/tmp/cursor-deploy-20260325125047/backend.tar.gz' -C '/home/blog-server/app'
...
tar -xzf '/tmp/cursor-deploy-20260325125047/blog-admin-dist.tar.gz' -C '/usr/share/nginx/html/blog-admin/current'
...
tar -xzf '/tmp/cursor-deploy-20260325125047/blog-front-dist.tar.gz' -C '/usr/share/nginx/html/blog-front/current'
echo 'Frontend deployed: blog-front -> /usr/share/nginx/html/blog-front/current/dist'

rm -rf '/tmp/cursor-deploy-20260325125047'
