...
tar -xzf '/tmp/cursor-deploy-20260325134549/backend.tar.gz' -C '/home/blog-server/app'
...
tar -xzf '/tmp/cursor-deploy-20260325134549/blog-admin-dist.tar.gz' -C '/usr/share/nginx/html/blog-admin' --strip-components=1
...
tar -xzf '/tmp/cursor-deploy-20260325134549/blog-front-dist.tar.gz' -C '/usr/share/nginx/html/blog-front' --strip-components=1
echo 'Frontend deployed (flat): blog-front -> /usr/share/nginx/html/blog-front'

rm -rf '/tmp/cursor-deploy-20260325134549'
